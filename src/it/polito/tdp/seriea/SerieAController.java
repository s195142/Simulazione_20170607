...
public class SerieAController {
    ...
    void handleCarica(ActionEvent event) {
    	...
    	if(s!=null) {
    		txtResult.setText(model.doClassifica(s));
    	}else {
        	showMessage("Errore: selezionare una stagione");
    	}
    ...
    void initialize() {
		...
		boxTeam.getItems().addAll(Model.getAllTeams()); // LETTERA MAIUSCOLA MODEL
    }

	public void setModel(Model model) { // ctrl + 1 - 2
		this.model = model;
	}
